...
export default function ManufacturerFormSidePanel({
    ...
    const fetchDetails = async () => {
        ...
        try {
            ...
            toast.error("Failed to load manufacturer data.", { position: "top-right" });
        } finally {
            setFetching(false);
        }
    };
    ...
    const handleSubmit = async (e) => {
        ...
        if (config.mode === "update") {
            payloadToValidate.manufacturerId = Number(Array.isArray(id) ? id[0] : id);
        }
        ...
        try {
            ...
            if (config.mode === "add") {
                ...
                bodyObj.manufacturerId = Number(Array.isArray(id) ? id[0] : id);
            }
                            ...
                            <form onSubmit={handleSubmit} className="space-y-5">
                                ...
                                <div className="pt-4 flex items-center justify-end gap-3 border-t border-gray-100">
                                    ...
                                    <button
                                        type="submit"
                                        disabled={loading}
                                        className="rounded-lg bg-blue-600 px-5 py-2.5 text-sm font-medium text-white hover:bg-blue-700 transition disabled:opacity-50 cursor-pointer"
                                    >
