...
export default function BrandList() {
    ...
    const [formContext, setFormContext] = useState("brand-add");
    ...
    const openAdd = () => {
        setEditId(null);
        setFormContext("brand-add");
        setFormPanelOpen(true);
    };

    const openEdit = (id) => {
        setEditId(id);
        setFormContext("brand-update");
        setFormPanelOpen(true);
        setViewId(null);
    };
    ...
    return (
        <div className="fixed inset-0 flex flex-col bg-[#f5f6fa] overflow-hidden">
            <Header page="brands" onSearch={handleSearch} />
                ...
                <div className="flex-1 min-h-0 flex flex-col overflow-hidden">
                    ...
                    {!loading && !error && (
                        <DataTable
                            ...
                            data={brands}
                            filterableColumns={[
                                { id: "brandName", label: "Brand Name", filterKey: "brandName" },
                                { id: "brandCode", label: "Code", filterKey: "brandCode" },
                                { id: "companyName", label: "Company", filterKey: "companyName" },
                                { id: "manufacturerName", label: "Manufacturer", filterKey: "manufacturerName" },
