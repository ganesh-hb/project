...
export default function UomFormSidePanel({
    ...
    const fetchDetails = async () => {
        ...
        try {
            ...
            toast.error("Failed to load UOM data.", { position: "top-right" });
        } finally {
            setFetching(false);
        }
    };
    ...
    const handleSubmit = async (e) => {
        ...
        if (config.mode === "update") {
            payloadToValidate.uomId = Number(Array.isArray(id) ? id[0] : id);
        }
        ...
        try {
            ...
            if (config.mode === "add") {
                ...
                bodyObj.uomId = Number(Array.isArray(id) ? id[0] : id);
            }
